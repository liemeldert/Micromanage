...
class MDMConnector:
    ...
    def _create_command_plist(self, request_type: str, command_dict: Dict[str, Any] = None) -> bytes:
    ...
    async def install_profile(self, device_udid: str, profile_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        command_plist = self._create_command_plist('InstallProfile', command_dict)
        result = await self.enqueue_command(device_udid, command_plist)
    ...
    async def remove_profile(self, device_udid: str, profile_identifier: str) -> Dict[str, Any]:
        ...
        command_plist = self._create_command_plist('RemoveProfile', command_dict)
        result = await self.enqueue_command(device_udid, command_plist)
    ...
    async def install_app(self, device_udid: str, manifest_url: str, 
        ...
        command_plist = self._create_command_plist('InstallApplication', command_dict)
        result = await self.enqueue_command(device_udid, command_plist)
    ...
    async def remove_app(self, device_udid: str, bundle_identifier: str) -> Dict[str, Any]:
        ...
        command_plist = self._create_command_plist('RemoveApplication', command_dict)
        result = await self.enqueue_command(device_udid, command_plist)
    ...
    async def enable_lost_mode(self, device_udid: str, message: str, 
        ...
        command_plist = self._create_command_plist('EnableLostMode', command_dict)
        result = await self.enqueue_command(device_udid, command_plist)
        return result
